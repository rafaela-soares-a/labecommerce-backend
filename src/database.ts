...
function createPurchase (userId: string, productId: string, quatily: number, price: number, totalPrice: number): void{
    const purchase: TPurchase = {userId, productId, price, quatily, totalPrice}
